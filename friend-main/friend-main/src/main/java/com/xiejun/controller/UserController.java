...
import com.xiejun.model.request.GetNewUserInfoRequest;
import com.xiejun.model.request.UserLoginRequest;
import com.xiejun.model.request.UserRegisterRequest;
...
public class UserController {
    ...
    public BaseResponse<User> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        ...
        userService.signAvatarUrl(user);
...
//        User user = userService.getById(userId);
        ...
        userService.signAvatarUrl(safetyUser);
    ...
    public BaseResponse<List<User>> searchUsers(String username, HttpServletRequest request) {
        ...
        userService.signAvatarUrl(list);
    ...
    public BaseResponse<List<User>> searchUsersByTags(@RequestParam(required = false) List<String> tagNameList) {
        ...
        userService.signAvatarUrl(userList);
...
//        设计字符串id作为该用户标识
        ...
        userService.signAvatarUrl(userPage.getRecords());
...
//        User loginUser = userService.getLoginUser(request);
    ...
    public BaseResponse<List<User>> matchUsers(long num,String currentId,  HttpServletRequest request) throws IOException {
        ...
        userService.signAvatarUrl(users);
        try {
